...
public:
    void Add()
    {
        ...
        Student s1;
        s1.input();
        obj.open("StudentRecord.dat", ios::app | ios::binary);
    ...
    void display()
    {
        fstream obj2;
        Student s2;
        obj2.open("StudentRecord.dat", ios::in | ios::binary);
    ...
    void search(int roll)
    {
        fstream obj3;
        Student s3;
        obj3.open("StudentRecord.dat", ios::in | ios::binary);
        bool found = false;
    ...
    void deleteStudent(int roll)
    {
        ...
        Student s3;
        obj3.open("StudentRecord.dat", ios::in | ios::binary);
        obj.open("StudentRecord2.dat", ios::out | ios::binary);
        bool found = false;
        while (obj3.read((char *)&s3, sizeof(s3)))
        {
